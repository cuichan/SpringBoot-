                                        ...
                                        <div class="modal fade" :id="'update-bot-btn-'+bot.id" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-xl">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="button" class="btn btn-primary" @click="update_bot(bot)">确定修改</button>
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">取消</button>
                                                </div>
                                                </div>
                                            </div>
...
export default ({
    ...
    "https://cdn.jsdelivr.net/npm/ace-builds@" + require('ace-builds').version + "/src-noconflict/")
        ...
        const refresh_bots = () =>{
            $.ajax({
                url: "https://app2652.acapp.acwing.com.cn/api/user/bot/getlist/",
                type: "get",
                headers: {
        ...
        const add_bot = () => {
                    ...
                    $.ajax({
                        url: "https://app2652.acapp.acwing.com.cn/api/user/bot/add/",
                        type: "post",
                        data: {
                            title: botadd.title,
        ...
        const remove_bot = (bot) => {
            $.ajax({
                url: "https://app2652.acapp.acwing.com.cn/api/user/bot/remove/",
                type: "post",
                data: {
                    bot_id: bot.id,
                },
        ...
        const update_bot = (bot) => {
            botadd.error_message = "";
            $.ajax({
                url: "https://app2652.acapp.acwing.com.cn/api/user/bot/update/",
                type: "post",
                data: {
                    bot_id: bot.id,
                    title: bot.title,
