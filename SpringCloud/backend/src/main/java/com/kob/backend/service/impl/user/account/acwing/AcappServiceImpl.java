...
public class AcappServiceImpl implements AcappService {
    private final static String appId = "2652";
    private final static String appSecret = "dd13d9b3769243109871fbf8537627a7";
    private final static String redirectUri = "https://app2652.acapp.acwing.com.cn/api/user/account/acwing/acapp/receive_code/";
